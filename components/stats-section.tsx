    ...
    <section className="w-full py-12 relative z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 lg:gap-3">
          ...
          >
            <div
              className="w-16 h-16 rounded-full border border-white/80 flex items-center justify-center mb-2 
      ...
      hover:scale-105"
            ...
            <h3 className="text-white font-semibold text-lg tracking-wide">See Results In 30 DAYS</h3>
          </motion.div>
      ...
      hover:scale-105"
            ...
            <h3 className="text-white font-semibold text-lg tracking-wide">Secure Data</h3>
          </motion.div>
      ...
      hover:scale-105"
            ...
            <h3 className="text-white font-semibold text-lg tracking-wide">Easy Setup</h3>
          </motion.div>
      ...
      hover:scale-105"
            ...
            <h3 className="text-white font-semibold text-lg tracking-wide">Regular Check-Ins</h3>
          </motion.div>
        </div>
      </div>
    </section>
